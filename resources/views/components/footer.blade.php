            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-4 text-xs font-medium text-slate-600">
                ...
                <div x-data="langSwitcher" class="relative notranslate" @click.outside="close()">
                    ...
                    <div
                        ...
                        class="lang-dropdown absolute bottom-full mb-2 left-0 rtl:left-auto rtl:right-0 w-52 bg-slate-900 border border-slate-700 rounded-2xl overflow-hidden overflow-y-auto z-50 py-1.5 shadow-2xl"
